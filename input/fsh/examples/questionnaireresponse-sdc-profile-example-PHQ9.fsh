...
* item
  ...
  * item[+]
    ...
    * answer.valueCoding = CodeSystemCSPHQ9#Not-at-all "Not at all"
  * item[+]
    * linkId = "H1/T1/Q2"
  ...
  * item[+]
    ...
    * answer.valueCoding = CodeSystemCSPHQ9#Several-days "Several days"
  * item[+]
    * linkId = "H1/T1/Q5"
    * text = "Poor appetite or overeating?"
    * answer.valueCoding = CodeSystemCSPHQ9#"More than half the days" "More than half the days"
  * item[+]
    * linkId = "H1/T1/Q6"
  ...
  * item[+]
    ...
    * answer.valueCoding = CodeSystemCSPHQ9#"Nearly every day" "Nearly every day"
  * item[+]
    * linkId = "H1/T1/Q8"
