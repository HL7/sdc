...
* rest
  ...
  * resource[+]
    ...
    * insert SearchParam(#SHOULD, "definition", #token,  http://hl7.org/fhir/SearchParameter/Questionnaire-definition)
    * insert SearchParam(#SHOULD, "context-type-quantity", #token, http://hl7.org/fhir/SearchParameter/Questionnaire-context-type-quantity)
    * insert SearchParam(#SHOULD, "context-type-value", #token, http://hl7.org/fhir/SearchParameter/Questionnaire-context-type-value)
  ...
  * resource[+]
    ...
    * insert SearchParam(#SHOULD, "context-type-quantity", #token, http://hl7.org/fhir/SearchParameter/conformance-context-type-quantity)
    * insert SearchParam(#SHOULD, "context-type-value", #token, http://hl7.org/fhir/SearchParameter/conformance-context-type-value)
