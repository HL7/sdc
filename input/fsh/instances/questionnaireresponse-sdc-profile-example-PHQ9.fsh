...
* item
  ...
  * item[0]
    ...
    * answer.valueCoding = #Not-at-all "Not at all"
  * item[+]
    * linkId = "H1/T1/Q2"
  ...
  * item[+]
    ...
    * answer.valueCoding = #Several-days "Several days"
  * item[+]
    * linkId = "H1/T1/Q5"
    * text = "Poor appetite or overeating?"
    * answer.valueCoding = #"More than half the days" "More than half the days"
  * item[+]
    * linkId = "H1/T1/Q6"
  ...
  * item[+]
    ...
    * answer.valueCoding = #"Nearly every day" "Nearly every day"
  * item[+]
    * linkId = "H1/T1/Q8"
